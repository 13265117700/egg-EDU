  ...
  <div class="main-right">
          ...
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item icon="el-icon-edit">
                <el-button type="text" @click="handStorieEdit(item)">编辑</el-button>
              </el-dropdown-item>
              <el-dropdown-item icon="el-icon-folder-delete">
                <el-button type="text" @click="handStorieDelete(item,index)">删除</el-button>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
            ...
            <el-dropdown trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item icon="el-icon-view">
                  <el-button type="text" @click="tasksContent(tasks)">内容</el-button>
                </el-dropdown-item>
                <el-dropdown-item icon="el-icon-folder-delete">
                  <el-button type="text" @click="tasksDelete(tasks)">删除</el-button>
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
    ...
    <el-drawer
      ...
      <el-form
        ...
        <el-form-item>
          <el-button type="primary" class="add_tasks_button" @click="handTasksEdit">保存</el-button>
        </el-form-item>
      </el-form>
    </el-drawer>
  </div>
